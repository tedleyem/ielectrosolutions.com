...
import { ContentWithPaddingXl, Container as ContainerBase } from "ie-components/misc/Layouts";
...
export default ({
  ...
  text = "Developers all over the world are happily using IElectroFix Solutions.",
  link1Text = "App Store",
